        ...
        <view class="contacts">
          ...
          <view class="value">
             <radio-group @change="statusChange">
                <label class="radio"><radio value="A" color="##373F64" :checked="couponInfo.status == 'A' ? true : false"/>启用</label>
                <label class="radio"><radio value="C" color="##373F64" :checked="couponInfo.status == 'C' ? true : false"/>过期</label>
                <label class="radio second"><radio value="N" color="##373F64" :checked="couponInfo.status == 'N' ? true: false"/>禁用</label>
             </radio-group>
          </view>
        </view>
      </view>
